...
<font color="red">UNDER CONSTRUCTION</font> Cherry Pick Palette: <code>CherryPickPalette(name, name2, name3)</code>
</h2>

Input 2 to 3 palettes to visually select colors to create new palette
